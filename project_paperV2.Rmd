...
```
In order to compare the AICc's values across ARIMA models, we kept the differences the same where $d=1$ and $D=0$ since we only performed one nonseasonal difference. After observing the PACF for the nonseasonal AR component, we tested different values for p such as 5, 4, and 2.
